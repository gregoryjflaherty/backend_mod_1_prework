...
#1. The if statement provides an option for Ruby to run the code in the next indented code block.
...
#3. If the code isn't indented, then Ruby will throwback an error stating that an end was
# expected.
#4. N/A
